	...
	public class Paging
	{
        public string Pagination(int total, int page, int Take, int offset, string Controler, string View, string Params)
        {
            if (total > 0)
            {
                ...
                if (current > 1) numPage += "<li class='previous page-item'><a class='page-link' href='" + URL + Controler + View + Params + "?Page=" + (page - 1)  + "' aria-label='Previous'>&laquo;</a></li>";
                ...
                if (current > (offset + 1)) numPage += "<li class='page-item'><a class='page-link'  href='" + URL + Controler + View + Params + "?Page=1" + "' name='page1'>1</a></li><li class='disabled spacing-dot page-item'><a class='page-link'  href='#'>...</a></li>";
                for (int i = 1; i <= totalPage; i++)
                {
                    if (pageStart <= i && pageEnd >= i)
                    {
                        ...
                        else numPage += "<li class='page-item'><a class='page-link'  href='" + URL + Controler + View + Params + "?Page=" + i + "'>" + i + "</a></li>";
                    }
                }
                if (totalPage > pageEnd)
                {
                    record = offset;
                    numPage += "<li class='disabled spacing-dot page-item'><a class='page-link'  href='#'>...</a></li><li><a class='page-link'  href='" + URL + Controler + View + Params + "?Page=" + (totalPage) + "'>" + totalPage + "</a></li>";
                }
                if (current < totalPage) numPage += "<li class='next class='page-item''><a class='page-link ui-bar-d' href='" + URL + Controler + View + Params + "?Page=" + (page + 1) + "'>&raquo;</a></li>";
